...
btnClear=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial','20','bold'),text="C",bg="powder blue",command=lambda : btnClearDisplay()).grid(row=4,column=1)
